/* ========================================================================
 * Ratchet Plus: Drawer.js v1.0.0
 * http://rc.kimsq.com/extensions/drawer/
 * ========================================================================
...
(function (c, b) {
      var a = a || function (k) {
            var f = { element: null, dragger: null, disable: "none", addBodyClasses: true, hyperextensible: true, resistance: 0.5, flickThreshold: 50, transitionSpeed: 0.3, easing: "ease", maxPosition: 266, minPosition: -266, tapToClose: true, touchToDrag: true, slideIntent: 40, minDragDistance: 5 },
                ...
                h = {},
                d = { hasTouch: b.ontouchstart === null, eventType: function eventType(m) {
                        var l = { down: d.hasTouch ? "touchstart" : "mousedown", move: d.hasTouch ? "touchmove" : "mousemove", up: d.hasTouch ? "touchend" : "mouseup", out: d.hasTouch ? "touchcancel" : "mouseout" };return l[m];
                  }, page: function page(l, m) {
                        return d.hasTouch && m.touches.length && m.touches[0] ? m.touches[0]["page" + l] : m["page" + l];
                  }, klass: { has: function has(m, l) {
                              return m.className.indexOf(l) !== -1;
                        }, add: function add(m, l) {
                              if (!d.klass.has(m, l) && f.addBodyClasses) {
                                    m.className += " " + l;
                              }
                        }, remove: function remove(m, l) {
                              if (f.addBodyClasses) {
                                    m.className = m.className.replace(l, "").replace(/^\s+|\s+$/g, "");
                              }
                        } }, dispatchEvent: function dispatchEvent(l) {
                  ...
                  }, deepExtend: function deepExtend(l, n) {
                        var m;for (m in n) {
                  ...
                  }, angleOfDrag: function angleOfDrag(l, o) {
                        var n, m;m = Math.atan2(-(e.startDragY - o), e.startDragX - l);if (m < 0) {
                              m += 2 * Math.PI;
                        }n = Math.floor(m * (180 / Math.PI) - 180);if (n < 0 && n > -180) {
                              n = 360 - Math.abs(n);
                        }return Math.abs(n);
                        ...
                        }, prevent: function prevent(l) {
                              if (l.preventDefault) {
                                    l.preventDefault();
                              } else {
                                    l.returnValue = false;
                              }
                        } }, parentUntil: function parentUntil(n, l) {
                        var m = typeof l === "string";while (n.parentNode) {
                ...
                i = { translate: { get: { matrix: function matrix(n) {
                                    if (!d.canTransform()) {
                                          return parseInt(f.element.style.left, 10);
                                    } else {
                                          var m = c.getComputedStyle(f.element)[e.vendor + "Transform"].match(/\((.*)\)/),
                                              l = 8;if (m) {
                                                m = m[1].split(",");if (m.length === 16) {
                                                      n += l;
                                                }return parseInt(m[n], 10);
                                          }return 0;
                                    }
                              } }, easeCallback: function easeCallback() {
                              f.element.style[e.vendor + "Transition"] = "";e.translation = i.translate.get.matrix(4);e.easing = false;clearInterval(e.animatingInterval);if (e.easingTo === 0) {
                                    d.klass.remove(b.body, "snapjs-right");d.klass.remove(b.body, "snapjs-left");
                              }d.dispatchEvent("animated");d.events.removeEvent(f.element, d.transitionCallback(), i.translate.easeCallback);
                        }, easeTo: function easeTo(l) {
                              if (!d.canTransform()) {
                                    e.translation = l;i.translate.x(l);
                              } else {
                                    e.easing = true;e.easingTo = l;f.element.style[e.vendor + "Transition"] = "all " + f.transitionSpeed + "s " + f.easing;e.animatingInterval = setInterval(function () {
                                          d.dispatchEvent("animating");
                                    }, 1);d.events.addEvent(f.element, d.transitionCallback(), i.translate.easeCallback);i.translate.x(l);
                              }if (l === 0) {
                              ...
                              }m = parseInt(m, 10);if (isNaN(m)) {
                                    m = 0;
                              }if (d.canTransform()) {
                                    var l = "translate3d(" + m + "px, 0,0)";f.element.style[e.vendor + "Transform"] = l;
                              } else {
                                    f.element.style.width = (c.innerWidth || b.documentElement.clientWidth) + "px";f.element.style.left = m + "px";f.element.style.right = "";
                              }
                        } }, drag: { listen: function listen() {
                              e.translation = 0;e.easing = false;d.events.addEvent(f.element, d.eventType("down"), i.drag.startDrag);d.events.addEvent(f.element, d.eventType("move"), i.drag.dragging);d.events.addEvent(f.element, d.eventType("up"), i.drag.endDrag);
                        }, stopListening: function stopListening() {
                              d.events.removeEvent(f.element, d.eventType("down"), i.drag.startDrag);d.events.removeEvent(f.element, d.eventType("move"), i.drag.dragging);d.events.removeEvent(f.element, d.eventType("up"), i.drag.endDrag);
                        }, startDrag: function startDrag(n) {
                              var m = n.target ? n.target : n.srcElement,
                                  l = d.parentUntil(m, "data-snap-ignore");if (l) {
                                    d.dispatchEvent("ignore");return;
                              }if (f.dragger) {
                                    var o = d.parentUntil(m, f.dragger);if (!o && e.translation !== f.minPosition && e.translation !== f.maxPosition) {
                                          return;
                                    }
                              }d.dispatchEvent("start");f.element.style[e.vendor + "Transition"] = "";e.isDragging = true;e.hasIntent = null;e.intentChecked = false;e.startDragX = d.page("X", n);e.startDragY = d.page("Y", n);e.dragWatchers = { current: 0, last: 0, hold: 0, state: "" };e.simpleStates = { opening: null, towards: null, hyperExtending: null, halfway: null, flick: null, translation: { absolute: 0, relative: 0, sinceDirectionChange: 0, percentage: 0 } };
                        }, dragging: function dragging(s) {
                              if (e.isDragging && f.touchToDrag) {
                                    var v = d.page("X", s),
                                        ...
                                        p = o > 0,
                                        q = n,
                                        w;if (e.intentChecked && !e.hasIntent) {
                                          return;
                                    }if (f.addBodyClasses) {
                                          if (o > 0) {
                                                d.klass.add(b.body, "snapjs-left");d.klass.remove(b.body, "snapjs-right");
                                          } else {
                                                if (o < 0) {
                                                      d.klass.add(b.body, "snapjs-right");d.klass.remove(b.body, "snapjs-left");
                                                }
                                          }
                                    }if (e.hasIntent === false || e.hasIntent === null) {
                                          var m = d.angleOfDrag(v, u),
                                              l = m >= 0 && m <= f.slideIntent || m <= 360 && m > 360 - f.slideIntent,
                                              r = m >= 180 && m <= 180 + f.slideIntent || m <= 180 && m >= 180 - f.slideIntent;if (!r && !l) {
                                                e.hasIntent = false;
                                          } else {
                                                e.hasIntent = true;
                                          ...
                                          return;
                                    }d.events.prevent(s);d.dispatchEvent("drag");e.dragWatchers.current = v;if (e.dragWatchers.last > v) {
                                          if (e.dragWatchers.state !== "left") {
                                                e.dragWatchers.state = "left";e.dragWatchers.hold = v;
                                          }e.dragWatchers.last = v;
                                    } else {
                                          if (e.dragWatchers.last < v) {
                                                if (e.dragWatchers.state !== "right") {
                                                      e.dragWatchers.state = "right";e.dragWatchers.hold = v;
                                                }e.dragWatchers.last = v;
                                          }
                                    }if (p) {
                                          if (f.maxPosition < o) {
                                                w = (o - f.maxPosition) * f.resistance;q = n - w;
                                          ...
                                          if (f.minPosition > o) {
                                                w = (o - f.minPosition) * f.resistance;q = n - w;
                        ...
                        }, endDrag: function endDrag(m) {
                              if (e.isDragging) {
                                    d.dispatchEvent("end");var l = i.translate.get.matrix(4);if (e.dragWatchers.current === 0 && l !== 0 && f.tapToClose) {
                                          d.dispatchEvent("close");d.events.prevent(m);i.translate.easeTo(0);e.isDragging = false;e.startDragX = 0;return;
                                    ...
                                    }e.isDragging = false;e.startDragX = d.page("X", m);
                              }
                        } } },
                j = function j(l) {
                  if (l.element) {
                  ...
                  d.dispatchEvent("open");d.klass.remove(b.body, "snapjs-expand-left");d.klass.remove(b.body, "snapjs-expand-right");if (l === "left") {
                        e.simpleStates.opening = "left";e.simpleStates.towards = "right";d.klass.add(b.body, "snapjs-left");d.klass.remove(b.body, "snapjs-right");i.translate.easeTo(f.maxPosition);
                  } else {
                        if (l === "right") {
                              e.simpleStates.opening = "right";e.simpleStates.towards = "left";d.klass.remove(b.body, "snapjs-left");d.klass.add(b.body, "snapjs-right");i.translate.easeTo(f.minPosition);
                        }
                  }
            };this.close = function () {
                  d.dispatchEvent("close");i.translate.easeTo(0);
            };this.expand = function (l) {
                  var m = c.innerWidth || b.documentElement.clientWidth;if (l === "left") {
                        d.dispatchEvent("expandLeft");d.klass.add(b.body, "snapjs-expand-left");d.klass.remove(b.body, "snapjs-expand-right");
                  } else {
                        d.dispatchEvent("expandRight");d.klass.add(b.body, "snapjs-expand-right");d.klass.remove(b.body, "snapjs-expand-left");m *= -1;
                  ...
                  d.dispatchEvent("enable");i.drag.listen();
            };this.disable = function () {
                  d.dispatchEvent("disable");i.drag.stopListening();
            };this.settings = function (l) {
                  d.deepExtend(f, l);
            };this.state = function () {
                  var l,
                      m = i.translate.get.matrix(4);if (m === f.maxPosition) {
                        l = "left";
                  } else {
                        if (m === f.minPosition) {
                              l = "right";
...
}).call(undefined, window, document);

// Function : Initialize Snap.js
var RC_initDrawer = function RC_initDrawer() {
...
!(function ($) {
      ...
      Drawer.prototype.show = function (_relatedTarget) {
            ...
            // drawer open
            if (this.showType == 'default') snapper.open(this.direction);else if (this.showType == 'expand') snapper.expand(this.direction);else if (this.showType == 'toggle') {
                  if (snapper.state().state == this.direction) this.hide();else snapper.open(this.direction);
            }
      ...
      Drawer.prototype.backdrop = function (callback) {
            if (this.isShown && this.options.backdrop) {
                  this.$backdrop = $(document.createElement('div')).addClass('backdrop').appendTo(this.options.bcontainer);
