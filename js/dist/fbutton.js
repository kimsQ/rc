...
!(function ($) {
      ...
      var Fbutton = function Fbutton(element, options) {
      ...
      function Plugin(option, _relatedTarget) {
            return this.each(function () {
                  ...
                  if (typeof option == 'string' && option != 'toggle') data[option](_relatedTarget);else if (options.toggle) data.toggle(_relatedTarget);
            });
      }
...
//# sourceMappingURL=fbutton.js.map
