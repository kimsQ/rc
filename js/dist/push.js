...
!(function () {
  ...
  var checkPopstate = function checkPopstate() {
  ...
  var popstate = function popstate(e) {
    ...
    if (objType != undefined) return;else {
      ...
      swapContent((activeObj.contents || activeDom).cloneNode(true), document.querySelector('.content'), transition);
